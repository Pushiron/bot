    ...
    if isAdmin==True:
        ...
        if len(msg) > 1:
            ...
            msg = await bot.send_message(message.chat.id, 'Команды администратора:\n'
                                            ...
                                            '/list <param> - выводит список по заданному параметру\n'
                                            '/makeadmin <user_id> - делает пользователя администратором\n'
                                            '/makeuser <user_id> - делает администратора пользователем\n'
